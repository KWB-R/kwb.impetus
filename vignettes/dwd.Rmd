...
print_to_pdf(gg, file = sprintf("dwd_berlin_monthly_%s.pdf", 
                                sel_para$file_postfix), width.cm = 50)
```
...
print_to_pdf(gg, file =  sprintf("dwd_berlin_monthly_%s.pdf", 
                                sel_para$file_postfix), width.cm = 35)
```
...
files <- sprintf("dwd_berlin_monthly_%s.pdf", dwd_timeperiod$file_postfix)

file_exists <- fs::file_exists(files)
