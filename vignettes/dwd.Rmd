...
aggregate_and_plot_to_pdf <- function(parameter, colors, file) {
...
```{r precipitation}
aggregate_and_plot_to_pdf(
  parameter = "precipitation",
  colors = c(
    'darkblue', 'blue', 'darkgreen', 'lightgreen', 'orange', 'red'
  ),
  file = "dwd_monthly_precipitation.pdf",
  width.cm = 50
)
```
...
aggregate_and_plot_to_pdf(
  ...
  file = "dwd_monthly_potential-evaporation.pdf",
  width.cm = 35
)
```
